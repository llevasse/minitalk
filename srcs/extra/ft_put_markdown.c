...
/*   Updated: 2023/06/05 16:31:53 by llevasse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_put_markdown(t_extra *extra, unsigned char c)
{
	...
	if ((c == '*' || c == '_') && extra->md.bold_c_nb == 0
		&& extra->md.is_italic == 0)
		return ((void)(write(1, "\x1B[3m", 5), extra->md.bold_c_nb = 1));
	if ((c == '*' || c == '_') && extra->md.bold_c_nb == 0
		&& extra->md.is_italic == 1)
		return ((void)(write(1, "\x1B[23m", 5), extra->md.bold_c_nb = 1));
}
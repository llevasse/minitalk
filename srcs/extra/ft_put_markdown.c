...
/*   Updated: 2023/06/05 19:04:46 by llevasse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (c == '\\' && extra->md.backslash == 0)
		return ((void)(extra->md.backslash = 1));
	if (extra->md.backslash == 1)
		return ((void)(write(1, &c, 1), extra->md.backslash = 2));
	...
	{
		extra->md.bold_c_nb = 2;
		return ((void)(write(1, "\x1B[22m", 5), extra->md.is_italic = 0));
	}
	if (c == '*' && extra->md.bold_c_nb == 2 && extra->md.is_bold == 0)
	{
		extra->md.bold_c_nb = 3;
		return ((void)(write(1, "\x1B[3m", 5), extra->md.is_bold = 1));
	}
	if (c == '*' && extra->md.bold_c_nb == 2 && extra->md.is_italic == 1)
	{
		extra->md.bold_c_nb = 3;
		return ((void)(write(1, "\x1B[23m", 5), extra->md.is_bold = 0));
	}
